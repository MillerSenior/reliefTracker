...
const getIcon = (type: ResourceLocation['type'], description: string): LucideIcon => {
  ...
  if (description.toLowerCase().includes('laundry')) return Shirt; // Assuming 'Shirt' icon for laundry
...
export const resourceLocations: ResourceLocation[] = [
  { 
    ...
    coordinates: { lat: 38.6508, lng: -90.2409 } // Approx.
  },
  { 
    id: "ville-hub", 
...
export const resourceTypes: ResourceLocation['type'][] = ['Shelter', 'Distribution Center', 'Food', 'Services', 'Hub'];
